...
// Admin
Route::group(['prefix' => config('backpack.base.route_prefix'), 'middleware' => ['admin'], 'namespace' => '\\App\\Http\\Controllers\\Admin'], function () {
    ...
    // Route::crud('animal', 'AnimalCrudController'); // controller not implemented
    ...
    // Route::crud('store/shipments', 'StoreShipmentCrudController'); // controller not implemented
