...
@php
  $breadcrumbs = [
    config('backpack.base.project_name') => backpack_url('dashboard'),
...
<section class="container-fluid">
    <h2>{{ config('app.name') }} <small>{{ __('Admin Panel') }}</small></h2>
</section>
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-3">
                <div class="card-header">
                  <a data-toggle="collapse" href="#collapseOne" class="text-dark">
                      Acções administrativas <i class="fa fa-angle-down" style="font-size: 12px; margin-left: 10px;"></i>
                  </a>
                </div>
                <div id="collapseOne" class="collapse">
                    <div class="card-body">
                        ...
                        <button path="/admin/cache/config" success="Configurações em cache" class="btn btn-secondary ajax">Cache config</button>
                        <button path="/admin/cache/config/clear" success="Cache das configurações limpas" class="btn btn-secondary ajax">Limpar cache config</button>
                        {{-- <button path="/admin/cache/route" success="Routes em cache" class="btn btn-secondary ajax">Cache route</button>
                        <button path="/admin/cache/route/clear" success="Cache das routes limpas" class="btn btn-secondary ajax">Limpar cache route</button>
                        <button path="/admin/cache/view" success="Views em cache" class="btn btn-secondary ajax">Cache view</button>
                        <button path="/admin/cache/view/clear" success="Cache das views limpas" class="btn btn-secondary ajax">Limpar cache view</button> --}}
                        <div style="margin-bottom: 5px;"></div>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ __('Stats') }}</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ __('Graphs') }}</h5>
                </div>
                <div class="graphs">
